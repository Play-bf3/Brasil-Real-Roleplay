...
module.exports = {
  ...
  .setTimestamp();
    ...
    let sisteanti = db.get(`sistelevel_${message.guild.id}`);
    if (sisteanti == null) {
  const ad = new Discord.MessageEmbed()
  .setColor('5fa5e3')
...
if(method != "info" && method != "delete" && method != "deleteall" && method != "add") {
   ...
   .setDescription(`Use o comando : \`${prefix}lc <delete|deleteall|add|info> <canal> !\``)
   .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
   .setTimestamp();
  ...
  let temvip = db.all().filter(data => data.ID.startsWith(`levelschannel_${message.guild.id}_`)).sort((a, b) => b.data - a.data);
  const limite = new Discord.MessageEmbed()
  .setColor('5fa5e3')
  .setDescription(`<:fechar:918747498984665108> <:W_aaaaBR:844415186474500166>Não encontrei canais de levels na minha database !`)
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
  ...
  for (let i = 0; i < temvip.length; i++) {
    ...
    if(temvip[i].ID.startsWith(`levelschannel_${message.guild.id}_`)) {
    
db.delete(`levelschannel_${message.guild.id}_${temvip[i].ID.split("_")[2]}`)
 ...
 return  message.reply({embeds:[a]})
  ...
  .setColor('5fa5e3')
  .setDescription(`<:fechar:918747498984665108> <:W_aaaaBR:844415186474500166>Não encontrei esse canal de level na minha database !`)
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
  ...
  db.delete(`levelschannel_${message.guild.id}_${channel.id}`)
  const limite = new Discord.MessageEmbed()
  .setColor('5fa5e3')
...
.setThumbnail(message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTitle(`<:chat:844778163493666857> <:W_aaaaBR:844415186474500166>Canais Levels !`)
 ...
 message.reply({embeds:[embed]})
  ...
  .setTimestamp();
    ...
    const limite = new Discord.MessageEmbed()
    .setColor('5fa5e3')
    .setDescription(`<:fechar:918747498984665108> <:W_aaaaBR:844415186474500166>A lista de canais de levels está cheia. Use ${prefix}lc delete para deletar.`)
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
    ...
    let ch = db.get(`levelschannel_${message.guild.id}_${channel.id}`) 
    const cdch = new Discord.MessageEmbed()
  .setColor('5fa5e3')
  .setDescription(`<:fechar:918747498984665108> <:W_aaaaBR:844415186474500166>Este canal já está na lista como canal de level`)
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
   ...
   db.set(`levelschannel_${message.guild.id}_${channel.id}`, true) 
