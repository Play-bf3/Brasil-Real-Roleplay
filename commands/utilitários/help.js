...
.setImage('https://media.discordapp.net/attachments/935333407305637991/937057668256923658/Sem_titulo11.jpg')
 ...
 .setTimestamp();
  ...
  //.setThumbnail(client.user.displayAvatarURL({dynamic : true, format : "png", size : 2048 }))
    ...
    .setImage('https://media.discordapp.net/attachments/935333407305637991/937058570602688572/Sem_titulo11.jpg')
    .setColor('5fa5e3')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  ...
  .setImage('https://media.discordapp.net/attachments/935333407305637991/937059199005900810/Sem_titulo11.jpg')
    .setColor('5fa5e3')
 ...
 // .setThumbnail(client.user.displayAvatarURL({dynamic : true, format : "png", size : 2048 }))
    .setImage('https://media.discordapp.net/attachments/935333407305637991/937060201138384896/Sem_titulo11.jpg')
...
//  .setThumbnail(client.user.displayAvatarURL({dynamic : true, format : "png", size : 2048 }))
    .setImage('https://media.discordapp.net/attachments/935333407305637991/937060794347163678/Sem_titulo11.jpg')
  ...
  // .setThumbnail(client.user.displayAvatarURL({dynamic : true, format : "png", size : 2048 }))
    .setImage('https://media.discordapp.net/attachments/935333407305637991/937061322418442300/Sem_titulo11.jpg')
