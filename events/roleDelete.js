...
try{
  let sistelevel = db.get(`roledel_${role.guild.id}`);
  ...
  .setTitle("<:Reg:844417596081307689> Cargo deletado")
  .setColor("5fa5e3")
  .setTimestamp()
  .setDescription(`<:forma:918749758632378408> Deletado por : ${log.executor} \n<:forma:918749758632378408> Nome do cargo : \`${role.name}\` \n<:forma:918749758632378408> ID do cargo : \`${role.id}\` `)
