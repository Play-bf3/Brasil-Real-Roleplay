...
let l1 = db.get(`logdemsg_${message.guild.id}`)
if(l1 == null) l1 = '\`Nenhum canal setado\`'
else l1 = `<#${l1}>`

    let msglog = db.get(`logdemsg_${message.guild.id}`)
    if(msglog == null) msglog = '\`Nenhum canal setado\`'
    else msglog = `<#${msglog}>`
    let msglogdel = db.get(`msgdel_${message.guild.id}`)
    if(msglogdel == null) msglogdel = '<:Desligado:906795288797257778>'
    else msglogdel = '<:Ligado:906795236011933726>'
    let msglogedit= db.get(`msgedit_${message.guild.id}`)
...
switch (r.customId) {
 ...
 case 'butao2':
  ...
  if(msglogedit === '<:Desligado:906795288797257778>'){
    ...
    .setDescription(`<:e_fixadoTDN:844359619886579732> Hey, ${message.member} Você precisa setar o canal de msg log `)
    .setColor('5fa5e3')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de mensagem editada **habilitado.**`)
    .setColor('5fa5e3')
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de mensagem editada **desabilitado.**`)
    .setColor('5fa5e3')
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de mensagem deletada **habilitado.**`)
    .setColor('5fa5e3')
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de mensagem deletada **desabilitado.**`)
    .setColor('5fa5e3')
       ...
       case 'butao4':
        ...
        if(msglog !== l1){
          if(msglog == '\`Nenhum canal setado\`'){
            db.delete(`logdemsg_${message.guild.id}`)
          }else{
            db.set(`logdemsg_${message.guild.id}`,msglog.id)
            
          }
            }
          if(msglogdel == '<:Desligado:906795288797257778>'){
            db.delete(`msgdel_${message.guild.id}`)
          }else{
            db.set(`msgdel_${message.guild.id}`,'on')
            
          }
          if(msglogedit == '<:Desligado:906795288797257778>'){
            db.delete(`msgedit_${message.guild.id}`)
          }else{
            db.set(`msgedit_${message.guild.id}`,'on')
