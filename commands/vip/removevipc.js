...
module.exports = {
   ...
   .setDescription(`<:fechar:918747498984665108> | Este usuário não possui permissão no seu VIP.   ` )
   .setColor('5fa5e3')
...
if (!canalvip.permissionsFor(user).has("CONNECT")&&!canalvip.permissionsFor(user).has("VIEW_CHANNEL"))  return message.reply({embeds:[nopossuitag]})
    ...
    .setTitle('<a:dima:918882750570823691> Permissão VIP Removida! <a:dima:918882750570823691>')
