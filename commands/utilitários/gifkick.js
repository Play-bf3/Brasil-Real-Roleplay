...
db.set(`gifkick_${message.member.id}`,image)
let embed1 = new Discord.MessageEmbed()

.setDescription(`<:correto:918747498707824681> <:W_aaaaBR:844415186474500166>Kickgif setado com sucesso!`)
.setColor("#5fa5e3")
.setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
.setTimestamp();
