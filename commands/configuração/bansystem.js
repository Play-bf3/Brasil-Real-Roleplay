...
if(l1 == null) l1 = '\`Nenhum canal setado\`'
    ...
    .setColor('5fa5e3')
    .setDescription(`<a:estrela:918882750742810654> Configure nosso sistema de ban abaixo!\n\n<:lunium:918729484365070376> Canal de log : ${msglog}\n<:lunidois:918729484407029870> Sistema de membro banido : ${msglogedit}\n<:lunitres:918729484285411390> Sistema de membro desbanido : ${msglogdel}\n<:luniquatro:918729484318965810> Sistema anti privatização de ban : ${antipri}\n<:lunicinco:918729740825788456> Bloquear banimentos por outros bots: ${bloqbot}\n<:luniseis:918729740477665322> Salvar configuração`)
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp()
...
case 'butao2':
  ...
  if(msglogedit === '<:Desligado:906795288797257778>'){
    ...
    .setDescription(`<:e_fixadoTDN:844359619886579732> Hey, ${message.member} Você precisa setar o canal de ban log `)
    .setColor('5fa5e3')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de membro banido **habilitado.**`)
    .setColor('5fa5e3')
 ...
 message.channel.send({embeds:[dadasdsadasda]}).then((msg)=> { setTimeout(()=>{msg.delete()},4000)})
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de membro banido **desabilitado.**`)
    .setColor('5fa5e3')
...
case 'butao3':
  ...
  .setDescription(`<:correto:918747498707824681> | Sistema de membro desbanido **habilitado.**`)
  .setColor('5fa5e3')
  ...
  .setDescription(`<:correto:918747498707824681> | Sistema de membro desbanido **desabilitado.**`)
  .setColor('5fa5e3')
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de anti privatização de ban **habilitado.**`)
    .setColor('5fa5e3')
 ...
 r.message.edit({embeds:[embed32b1]})
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de anti privatização de ban **desabilitado.**`)
    .setColor('5fa5e3')
...
if(antipri === '<:Desligado:906795288797257778>'){
  let dadsad = new Discord.MessageEmbed()
  .setDescription(`<:e_fixadoTDN:844359619886579732> Hey, ${message.member} Você precisa habilitar a opção de anti privatização de ban para utilizar essa opção`)
  .setColor('5fa5e3')
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de bloquear banimentos por outros bot **habilitado.**`)
    .setColor('5fa5e3')
 ...
 r.message.edit({embeds:[embed32b1]})
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`<:correto:918747498707824681> | Sistema de bloquear banimentos por outros bot **desabilitado.**`)
    .setColor('5fa5e3')
